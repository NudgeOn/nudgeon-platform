-- Onda — ClickHouse 수집 테이블 4종 (PRD-01 5.2)
...
CREATE TABLE IF NOT EXISTS onda.raw_ingestions
(
    tenant_id   UUID,
    app_id      UUID,
...
CREATE TABLE IF NOT EXISTS onda.events
(
    tenant_id  UUID,
    app_id     UUID,
...
CREATE TABLE IF NOT EXISTS onda.attr_changes
(
    tenant_id  UUID,
    app_id     UUID,
    user_id    UUID,
...
CREATE TABLE IF NOT EXISTS onda.ingestion_errors
(
    tenant_id  UUID,
    app_id     UUID,

export const content = {
  en: {
    ...
    releaseNote: 'NudgeOn is a partner beta candidate. Native SDK 0.2.4 is published; RN/Flutter publication and operational beta gates remain open.',
  ...
  ko: {
    ...
    releaseNote: 'NudgeOn은 파트너 베타 후보입니다. 네이티브 SDK 0.2.4는 공개 배포됐으며 RN·Flutter 게시와 운영 베타 검증이 남아 있습니다.',

export const content = {
  en: {
    ...
    explore: 'Explore NudgeOn', alpha: 'Apache-2.0 · Push MVP Alpha · Self-hosted',
    ...
    releaseNote: 'NudgeOn is in alpha. Delivery reliability, SDK integration and operational checks are still in progress.',
  ...
  ko: {
    ...
    explore: 'NudgeOn 살펴보기', alpha: 'Apache-2.0 · Push MVP Alpha · 직접 설치·운영',
    ...
    releaseNote: 'NudgeOn은 현재 알파 버전입니다. 발송 안정성, SDK 연동, 운영 검증을 진행하고 있습니다.',

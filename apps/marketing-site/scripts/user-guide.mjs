...
const copy = {
  en: {
    ...
    scope: 'For operators working with a team that has installed NudgeOn and connected its app. NudgeOn is a partner beta candidate; native iOS and Android SDK 0.2.5 are published.',
  ...
  ko: {
    ...
    scope: 'NudgeOn을 설치하고 앱을 연결한 팀의 운영자를 위한 가이드입니다. 현재 파트너 베타 후보이며 iOS·Android SDK 0.2.5가 공개되어 있습니다.',

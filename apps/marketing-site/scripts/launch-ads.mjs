const copy = {
  ko: {
    ...
    integration: 'iOS·Android SDK 0.2.6와 앱 시작 화면 연결이 필요합니다. 기본 표시 시간은 4초이며 SDK에서 3~5초로 설정합니다.',
    docs: '시작 광고 연결 가이드',
  },
  en: {
    ...
    integration: 'Requires iOS or Android SDK 0.2.6 and a host-app startup integration. Display time defaults to 4 seconds and is configurable from 3 to 5 seconds in the SDK.',

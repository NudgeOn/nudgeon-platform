// Package metrics — Prometheus 지표 (PRD-08 §5, 네이밍 onda_<comp>_<metric>).
package metrics
...
var (
	...
	IngestProcessed = promauto.NewCounterVec(prometheus.CounterOpts{
		Name: "onda_ingest_events_processed_total",
	...
	SendsPublished = promauto.NewCounterVec(prometheus.CounterOpts{
		Name: "onda_scheduler_sends_published_total",

...
- 파일: `onda-logo-pigeon.png`
- 방향: 메시지를 전달하는 전서구, 날개 안의 파도 곡선, Onda 워드마크.
...
```text
Use case: logo-brand.
Asset type: primary brand logo for Onda, an open source customer engagement and message delivery platform.

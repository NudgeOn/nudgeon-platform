...
| # | 항목 | 필요한 것 | 완료 조건 |
|---|---|---|---|
| B-1 | SDK 공개 배포 | iOS SPM·Android core/in-app **0.2.2 완료**. RN/Flutter **0.1.3 준비·CI·머지 완료**, npm/pub.dev/CocoaPods 로그인·게시 대기 | 공개 registry-only 신규 앱 설치·계약 검증 |
...
| B-5 | 부하 (PT-1~8, M-5) | 자원 사전 점검·단일 tenant 부하 프로필 준비, 운영 환경 실측 미완료 | 5,000 ev/s·100만 토큰·24h soak 원본 수치 |

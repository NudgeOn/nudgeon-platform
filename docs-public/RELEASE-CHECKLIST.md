...
| P1-08 공개 저장소·패키지 | **부분 구현** — 플랫폼·4 SDK Apache-2.0 LICENSE/NOTICE, DCO 기여·상표 정책, 플랫폼 release workflow 존재 | SECURITY 안내, 실제 배포물의 완전한 제3자 고지/SBOM, 설치 URL·버전·새 앱 설치, secret·취약점·서명/멀티아치 검사. 이번 외부 registry/원격 CI는 조회하지 않음 |
